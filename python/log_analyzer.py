...
LOG_PATTERNS = {
    'apache': {
        ...
        'fields': ['ip', 'date', 'time', 'timezone', 'method', 'url', 'protocol', 'status', 'size', 'referer', 'user_agent']
    },
    'nginx': {
...
ERROR_PATTERNS = [
    r'error', r'fail', r'exception', r'traceback', r'fatal',
    r'warn', r'critical', r'denied', r'refused', r'timeout',
    r'unavailable', r'stacktrace', r'unauthorized', r'permission'
]
...
def analyze_log(log_file, format=None):
    ...
    summary = generate_summary(log_file, log_entries, errors, ip_stats, patterns, high_error_periods)
...
def main():
    ...
    parser.add_argument('--format', choices=list(LOG_PATTERNS.keys()), 
                      help='Log format (apache, nginx, syslog)')
